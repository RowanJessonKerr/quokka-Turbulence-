...
namespace quokka::TurbulentDriving{
 ...
 template <typename problem_t> void computeDriving(amrex::MultiFab &mf, const amrex::Real dt_in, amrex::GpuArray<amrex::Real, AMREX_SPACEDIM> const &cellSizes, TurbGenAmrex &tg)
{
	const Real dt = dt_in;
